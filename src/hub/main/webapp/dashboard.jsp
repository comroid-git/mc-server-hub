...
<%--@elvariable id="servers" type="java.util.List<org.comroid.mcsd.core.entity.Server>"--%>
<%--@elvariable id="connections" type="java.util.List<org.comroid.mcsd.core.entity.ShConnection>"--%>
