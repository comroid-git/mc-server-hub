...
<%--@elvariable id="servers" type="java.util.List<org.comroid.mcsd.entity.Server>"--%>
<%--@elvariable id="connections" type="java.util.List<org.comroid.mcsd.entity.ShConnection>"--%>
